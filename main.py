...
print("Running comparison ", iters,
      " times for graph size ", num_nodes,
      " nodes and update frequency of one in ", num_changes)
...
with open('results/update2/test%d_%d.csv' % (num_nodes, num_changes), 'a', newline='') as csvfile:
    ...
    for i in range(iters):
        ...
        gg.get_edge_changes(int(num_edges / num_changes))
